...
print(f"Present Value of the loan based on the monthly version of the present value formula is ${present_value: .2f}")
...
if present_value >= loan_price:
    print(f"At ${present_value: .2f}, the loan is worth at least the ${loan_price} cost to buy it.")
